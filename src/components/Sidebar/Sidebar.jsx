...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Small Screen Navbar */}
      <div className='bg-[#FFF8F5] text-gray-800 flex justify-between md:hidden'>
        <div>
      ...
      >
        ...
        <div>
          ...
          <button
            onClick={logOut}
            className='flex w-full items-center px-4 py-2 mt-5  hover:bg-gray-300   hover:text-[#F63E7B] transition-colors duration-300 transform'
          >
