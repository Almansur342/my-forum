			...
			<section className="container mx-auto px-4">
				<div className="container flex flex-col justify-center items-center mx-auto sm:py-12 lg:py-1 lg:flex-row lg:justify-between">
					<div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-lg xl:max-w-lg lg:text-left">
						<h1 className="text-2xl lg:text-5xl text-[#111430] font-bold leading-none sm:text-5xl">Engage, Share,<br />
						...
						<form onSubmit={handleSearch}>
							<div className='relative'>
								...
								<input
									type="text"
									name="search" placeholder="Search by tags" className="w-40 border border-[#F73E7B] py-1 lg:py-2 pl-10 text-base rounded-md sm:w-auto" />
								<button className='px-3 py-1 rounded-md ml-3 bg-[#F73E7B] text-white text-xs lg:text-lg uppercase'>Search</button>
							</div>
						</form>
					</div>
